<?php
/* Smarty version 4.2.0, created on 2023-03-16 11:40:34
  from 'C:\xampp\htdocs\datamax_copia\app\Views\admin\login.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_6413468287cd15_57464851',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5663f3d1564e3aebd758ee8267da12cf89f0631b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\datamax_copia\\app\\Views\\admin\\login.tpl',
      1 => 1678984833,
      2 => 'file',
    ),
  ),
...
function content_6413468287cd15_57464851 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="es">
...
img/admin/logo-login.png" class="dtm-login pd-30">
...
" id="form_login_admin" method="post">
          ...
          <div class="mb-3 pd-30">
            ...
            <button type="submit"
              class="btn-submit-login wd-170 btn-submit-form tx-16 pd-y-10 pd-x-20 tx-mont tx-medium "
              id="btn-user">Ingresar</button>
            <div class="mg-b-2 foot-login ">
...
" id="form_password_admin" method="post">
          ...
          <div class="mb-3 pd-30">
            <input type="email" class="form-control" name="email-password" id="email-password"
              placeholder="Correo electrónico">
            <button type="button"
              class="btn-submit-login wd-170 btn-submit-form tx-16 pd-y-10 pd-x-20 tx-mont tx-medium"
              id="btn-next">Siguiente</button>
            <button type="button"
              class="btn-submit-back  wd-170 btn-submit-form tx-16 pd-y-10 pd-x-20 tx-mont tx-medium "
              id="btn-back">Volver</button>
            <div class="mg-b-2 foot-login">
              <p class="mg-0">Este es un producto creado por <img src="<?php echo $_smarty_tpl->tpl_vars['RESOURCES']->value;?>
/img/admin/Grupo 658.svg" alt="conectera"
                  class="mg-l-4"></p>
...
" id="form_login_code" method="post">
          ...
          <p class="text-password">Ingresa el código de 4 digitos que fue enviado a tu correo electrónico registrado.
          </p>
          <div class="mb-3 pd-30">
            ...
            <button type="button"
              class="btn-submit-login wd-170 btn-submit-form tx-16 pd-y-10 pd-x-20 tx-mont tx-medium "
              id="btn-next2">Siguiente</button>
            <button type="button"
              class="btn-submit-back  wd-170 btn-submit-form tx-16 pd-y-10 pd-x-20 tx-mont tx-medium "
              id="btn-back2">Volver</button>
            <div class="mg-b-2 foot-login">
              <p class="mg-0">Este es un producto creado por <img src="<?php echo $_smarty_tpl->tpl_vars['RESOURCES']->value;?>
/img/admin/Grupo 658.svg" alt="conectera"
                  class="mg-l-4"></p>
...
img/admin/logo-login.png" class="dtm-login pd-30">
        ...
        <div class="mb-3">
          ...
          <input type="password" class="form-control" name="password-new" id="password-new"
            placeholder="Nueva contraseña" onkeyup="checkedValid()">
...
" id="form_password_new" method="post">
            ...
            <input type="password" class="form-control" name="password-repeat" id="password-login-2"
          ...
          <button type="button" class="btn-submit-login wd-170 btn-submit-form tx-16 pd-y-10 pd-x-20 tx-mont tx-medium "
            id="btn-next3">Siguiente</button>
          <button type="button" class="btn-submit-back  wd-170 btn-submit-form tx-16 pd-y-10 pd-x-20 tx-mont tx-medium "
            id="btn-back3">Volver</button>
          <div class="mg-b-2 foot-login">
            <p class="mg-0">Este es un producto creado por <img src="<?php echo $_smarty_tpl->tpl_vars['RESOURCES']->value;?>
/img/Grupo 658.svg" alt="conectera"
                class="mg-l-4"></p>
          </div>
        </div>
