...
$(document).ready(function()
{
    $("#open-menu").on("click", function () {
        $("#btnLeftMenu").removeClass("hid");
    })

    $("#close-menu").on("click", function () {
        $("#btnLeftMenu").addClass("hid");
    })
    ...
    $('#btnRightMenu').on('click', function()
    {
        ...
        if($('body').hasClass('collapsed-menu') && $('#btnLeftMenu').not(':visible')) 
        {
            $('body').removeClass('collapsed-menu');
            $('.show-sub + .br-menu-sub-right').slideDown();
            $('.br-sideright').one('transitionend', function(e) 
            {
    ...
    $(document).on("click", function(event) {
        var obj = $(".br-sideright");
        if (!$(event.target).closest(obj).length) {

            $('body').addClass('collapsed-menu');
            $('.br-sideright').css('display', 'block');
        }
    });
    ...
    $("#btnRightMenu").on('change', function(){
        $('body').addClass('collapsed-menu');
    })
    ...
    $('.br-menu-link-right').on('click', function()
    {
        var nextElem = $(this).next();
        var thisLink = $(this);

        if(nextElem.hasClass('br-menu-sub-right')) 
        {
            ...
            {
                $('.br-menu-link-right').each(function()
                {
                    $(this).removeClass('show-sub');
                });
                $('.br-menu-sub-right').each(function()
                {
                    $(this).slideUp();
                });
                thisLink.addClass('show-sub');
    ...
    $("#panel-fullscreen").click(function (e) 
    {
        ...
        if ($this.children('svg').hasClass('fa-expand-arrows-alt'))
        {
            ...
            $("#panel-fullscreen").attr('title', 'Contraer');
        ...
        else if ($this.children('svg').hasClass('fa-compress-arrows-alt'))
        {
            ...
            $("#panel-fullscreen").attr('title', 'Expandir');
