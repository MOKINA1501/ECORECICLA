        ...
        <div class="content-arr-docs">
            <div class="breadcrumb-arr-docs desktop-breadcrumb-arr-docs">
                ...
                <a class="links-breadcrumb-arr-docs">
                    ...
                    <label class="link-to-other-page-arr-docs active-breadcrumb">Borradores</label>
                </a>
                <a class="links-breadcrumb-arr-docs">
                    <span class="material-icons-round active-breadcrumb">chevron_left</span>
                    <label class="link-to-other-page-arr-docs active-breadcrumb">Editar borrador</label>
                </a>
            </div>
            <div class="breadcrumb-arr-docs tablet-breadcrumb-arr-docs">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-go-routes" aria-labelledby="dropdownMenuButton1">
                        <li class="mt-3 pl-2"><a class="link-to-other-page-arr-docs" href="#">Borradores</a></li>
                ...
                <div class="view-in-te-breadcrumb-arr-docs"><span class="material-icons-round">chevron_left</span>Editar
                    borrador</div>
            </div>
            ...
            <div class="container-arr-docs">
                <div class="container-content-arr-docs">
                    <div class="container-title-view-add-arr-docs">
                        ...
                        <label>Contrataciones Holding MAX</label>
                    </div>
                </div>
                <form class="form-add-arr-docs">
                    <div class="container-content-left-arr-docs">
                        <div class="container-main-information-arr-docs">
                            <div class="container-input-animated-arr-docs">
                                <input type="text" class="input-animated-arr-docs" id="main_users" required>
                                <label for="main_users" class="placeholder-animation-label-arr-docs">Para</label>
                            </div>
                            <div class="container-input-animated-arr-docs">
                                <input class="input-animated-arr-docs" type="text" name="main_users" id="with_copy"
                                    required>
                                <label class="placeholder-animation-label-arr-docs" for="with_copy">CC</label>
                            </div>
                    ...
                    <div class="container-anex-and-buttons-arr-docs">
                        <div class="container-anexos-information-arr-docs">
                            ...
                            <div class="container-input-animated-arr-docs comments-arr-docs-textarea">
                                <textarea class="input-animated-arr-docs textarea-comments-arr-docs" id="comment-add"
                                    required></textarea>
                                <label class="placeholder-animation-label-arr-docs" for="comment-add">Comentarios
                                    adicionales</label>
                            </div>
                        </div>
                        <div class="container-buttons-add-arr-docs">
                            <button class="btn-send-arr-docs">Enviar documento</button>
                            <button class="btn-save-draft-arr-docs">Guardar borrador</button>
                        </div>
                    </div>
